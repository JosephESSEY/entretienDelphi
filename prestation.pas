...
begin
  ...
  begin
    ...
    ShowMessage('Prestation Supprimé avec Succès');
    EdPrix.Text := '';
    EdAdresse.Text := '';
    ...
    DataModule1.QListePrestationClient.Close;
    DataModule1.QListePrestationClient.Open;
...
begin
  ...
  begin
    ...
    ShowMessage('Prestation Modifié avec Succès');
    EdPrix.Text := '';
    EdAdresse.Text := '';
    DBLookupComboBoxC.KeyValue := null;
    DBLookupComboBoxS.KeyValue := null;
...
begin
  ...
  begin
    ...
    ShowMessage('Prestation Inséré avec Succès');
    EdPrix.Text := '';
    EdAdresse.Text := '';
    DBLookupComboBoxC.KeyValue := null;
    DBLookupComboBoxS.KeyValue := null;
